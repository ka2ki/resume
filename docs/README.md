...
<a href="https://wakatime.com/@ka2ki" target='_blank' rel='noopener'>https://wakatime.com/@ka2ki</a>
</p>
...
- 担当：フロントエンド開発
- 開発環境： Next.js・TypeScript・HTML・Tailwind CSS・Github・GithubActions
- 内容：React を使用したフロント実装や WebSocket を使用した双方向通信実装（オペレーター権限）
